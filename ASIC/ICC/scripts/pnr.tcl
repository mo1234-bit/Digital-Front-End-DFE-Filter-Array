...
create_floorplan -core_utilization 0.25 \
	...
	-left_io2core 50.4 -bottom_io2core 50.4 -right_io2core 50.4 -top_io2core 50.4
...
# you can create them with gui. Preroute > Create Virtual Power Pad
 create_fp_virtual_pad -net VSS -point {828.0220 436.4100}
create_fp_virtual_pad -net VSS -point {827.3535 533.8115}
create_fp_virtual_pad -net VSS -point {829.1365 619.3995}
create_fp_virtual_pad -net VSS -point {828.9135 710.1145}
create_fp_virtual_pad -net VSS -point {829.3595 796.5940}
create_fp_virtual_pad -net VSS -point {761.6020 828.0210}
create_fp_virtual_pad -net VSS -point {666.6525 827.7985}
create_fp_virtual_pad -net VSS -point {576.1610 828.0210}
create_fp_virtual_pad -net VSS -point {485.4460 829.8040}
create_fp_virtual_pad -net VSS -point {402.7555 830.0270}
create_fp_virtual_pad -net VSS -point {299.1135 829.8040}
create_fp_virtual_pad -net VSS -point {210.1815 827.7985}
create_fp_virtual_pad -net VSS -point {117.9070 828.4670}
create_fp_virtual_pad -net VSS -point {28.7525 828.9125}
create_fp_virtual_pad -net VSS -point {-0.8915 761.3780}
create_fp_virtual_pad -net VSS -point {0.0000 665.5370}
create_fp_virtual_pad -net VSS -point {0.6685 576.6055}
create_fp_virtual_pad -net VSS -point {-0.4455 484.1080}
create_fp_virtual_pad -net VSS -point {-0.6685 392.0560}
create_fp_virtual_pad -net VSS -point {0.0000 301.5640}
create_fp_virtual_pad -net VSS -point {1.3375 209.5120}
create_fp_virtual_pad -net VSS -point {1.3375 117.6830}
create_fp_virtual_pad -net VSS -point {0.0000 23.4020}
create_fp_virtual_pad -net VSS -point {76.6730 -0.6695}
create_fp_virtual_pad -net VSS -point {176.0800 0.8905}
create_fp_virtual_pad -net VSS -point {276.8245 0.4445}
create_fp_virtual_pad -net VSS -point {368.8765 -2.4525}
create_fp_virtual_pad -net VSS -point {465.8320 0.8905}
create_fp_virtual_pad -net VSS -point {566.1310 1.3365}
create_fp_virtual_pad -net VSS -point {656.8455 -2.6755}
create_fp_virtual_pad -net VSS -point {758.2590 2.2280}
create_fp_virtual_pad -net VSS -point {829.8055 28.7515}
create_fp_virtual_pad -net VSS -point {828.4680 109.8820}
create_fp_virtual_pad -net VSS -point {829.3595 210.1805}
create_fp_virtual_pad -net VSS -point {828.4680 298.6665}
create_fp_virtual_pad -net VDD -point {25.8550 -0.8925}
create_fp_virtual_pad -net VDD -point {125.7080 1.3365}
create_fp_virtual_pad -net VDD -point {224.0005 2.2280}
create_fp_virtual_pad -net VDD -point {318.5045 -0.6695}
create_fp_virtual_pad -net VDD -point {411.8935 -0.8925}
create_fp_virtual_pad -net VDD -point {515.3130 -0.2235}
create_fp_virtual_pad -net VDD -point {607.3650 -0.8925}
create_fp_virtual_pad -net VDD -point {705.2120 0.2220}
create_fp_virtual_pad -net VDD -point {801.4985 -1.5610}
create_fp_virtual_pad -net VDD -point {828.6910 69.7625}
create_fp_virtual_pad -net VDD -point {830.0280 161.1455}
create_fp_virtual_pad -net VDD -point {827.7995 249.4085}
create_fp_virtual_pad -net VDD -point {829.3595 350.1530}
create_fp_virtual_pad -net VDD -point {829.1365 391.1640}
create_fp_virtual_pad -net VDD -point {829.1365 480.3185}
create_fp_virtual_pad -net VDD -point {829.1365 570.3645}
create_fp_virtual_pad -net VDD -point {829.3595 659.5190}
create_fp_virtual_pad -net VDD -point {829.5825 754.6915}
create_fp_virtual_pad -net VDD -point {806.4020 829.3585}
create_fp_virtual_pad -net VDD -point {713.0130 829.1355}
create_fp_virtual_pad -net VDD -point {622.7440 825.7925}
create_fp_virtual_pad -net VDD -point {530.4690 829.1355}
create_fp_virtual_pad -net VDD -point {441.0920 828.6900}
create_fp_virtual_pad -net VDD -point {348.8170 829.3585}
create_fp_virtual_pad -net VDD -point {250.7470 830.0270}
create_fp_virtual_pad -net VDD -point {162.7070 828.0210}
create_fp_virtual_pad -net VDD -point {77.5645 829.3585}
create_fp_virtual_pad -net VDD -point {2.4515 805.0640}
create_fp_virtual_pad -net VDD -point {-1.7830 714.1265}
create_fp_virtual_pad -net VDD -point {-0.4455 619.1770}
create_fp_virtual_pad -net VDD -point {-1.3370 524.6730}
create_fp_virtual_pad -net VDD -point {0.4460 435.2955}
create_fp_virtual_pad -net VDD -point {1.3375 341.9065}
create_fp_virtual_pad -net VDD -point {0.4460 252.7520}
create_fp_virtual_pad -net VDD -point {-0.2225 159.8085}
create_fp_virtual_pad -net VDD -point {-0.4455 70.4310}
...
set_driving_cell -lib_cell BUF_X16 -pin Z [get_ports clk_1]
###OR
